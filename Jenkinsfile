...
stage("SonarQube analysis") {
 ...
 stage("deploy"){
  steps{
   deploy adapters: [tomcat8(credentialsId: '5fd75889-3d4f-4807-b450-10d731be1fd5', path: '', url: 'http://3.16.163.67:8090')], contextPath: 'falconweb3', onFailure: false, war: '**/target/*.war'
  }
 }
}
}
